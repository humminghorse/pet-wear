  ...
  <div class="">
    <div class="">
      ...
      <form @submit.prevent class="mx-8 sm:mt-4">
        <!-- 名前 -->
        <div class="form-item">
          <label for="name" class="label sm:w-1/3">名前</label>
          <input id="name" v-model="store.name" type="text" class="input input-bordered w-full"/>
        </div>
        <!-- アイコン画像 -->
        <div class="form-item">
          <label for="iconFiles" class="label sm:w-1/3">アイコン画像</label>
          <input id="iconFiles" @change="uploadIconFile" type="file" class="w-full" />
        </div>
        <!-- 紹介文 -->
        <div class="form-item">
          <label for="introduction" class="label sm:w-1/3">紹介文</label>
          <textarea id="introduction" v-model="store.introduction" type="text" class="textarea textarea-bordered w-full"></textarea>
        </div>
        <!-- 分類 -->
        <div class="form-item">
          <legend for="classification" class="label sm:w-1/3">分類</legend>
          <div class="flex gap-4">
            <div class="form-control">
              <label class="label sm:w-1/3 cursor-pointer justify-start gap-2">
            ...
            <div class="form-control">
              <label class="label sm:w-1/3 cursor-pointer justify-start gap-2">
                ...
                <span class="label sm:w-1/3-text">猫</span> 
              </label>
            </div>
          </div>
        </div>
        <!-- 犬種/猫種 -->
        <div class="form-item">
          <label for="breed" class="label sm:w-1/3">猫種</label>
          <select v-model="store.breedId" class="select select-bordered w-full sm:w-1/3">
        ...
        <!-- 誕生日 -->
        <div class="form-item">
          <label for="birthday" class="label sm:w-1/3">誕生日</label>
        ...
        <!-- 体重 -->
        <div class="form-item">
          <label for="weightKg" class="label sm:w-1/3">体重(kg)</label>
          <input id="weightKg" v-model="store.weightKg" type="input-tel" class="input input-bordered w-full"/>
        </div>
        <!-- 毛の色 -->
        <div class="form-item">
          <legend for="furColor" class="label sm:w-1/3">毛の色</legend>
...
<style lang="sass">
  .form-item
    @apply sm:flex sm:p-4 sm:border sm:items-center
